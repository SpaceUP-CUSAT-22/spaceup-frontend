...
export default function About(){
    ...
    return <div className="flex h-screen flex-col bg-cover bg-bottom bg-no-repeat text-gray-50 w-screen justify-center  text-center items-center bg-[url('/home/vishnu/Desktop/spaceup-sss/sss/public/assets/About/astro-toursim.jpg')]">

    <div className="flex px-8 py-12 lg:py-10">

    
    <div className="space-y-24 my-auto max-w-7xl">
    <h1 className="text-4xl font-bold lg:text-4xl">About Us</h1>
