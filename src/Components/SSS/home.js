...
export default function Home() {
    return (
        <div id="Shome" className="flex w-full min-h-screen items-center bg-sss-bg-mobile sm:bg-sss-bg-tablet xl:bg-sss-bg bg-no-repeat bg-cover bg-fixed lg:p-5 flex-col justify-center">
            ...
            <div className="container w-full font-sans px-3 space-y-5 text-center md:px-1 bg-blur-xl">
                <Fade bottom duration={1000}>
                    <h1 className="text-white font-bold text-5xl md:text-6xl lg:text-7xl font-nasa tracking-wider">STUDENTS SPACE SUMMIT 2022</h1>
                </Fade>
